...
<html>
	...
	<body>
		...
		<a href="https://librarysystemnishant.000webhostapp.com/" style="margin-left:75px; margin-bottom:75px; vertical-align: middle;">Home</a>
	...
	<?php
		if(isset($_POST['m_login']))
		{
			...
			$query->bind_param("ss", $_POST['m_user'], $temp);
			$query->execute();
